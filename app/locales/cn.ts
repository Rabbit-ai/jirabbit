...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : "访问密码不正确或为空，请前往[登录](/#/auth)页输入正确的访间密码，或者在[设置](/#/settings)页填入你自己的 openAIAP Key。如没密码可以添加微信机器人:zalmanj，发送“密码”就可以获取密码(不定时更新额度，刚需建议自行购买key)。如有其他交流也可以留言，偶尔看机器人信息;左小角猫图标可以申请各种号卡",
  },
  Auth: {
    Title: "需要密码",
